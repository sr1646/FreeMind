	...
	<div class="section">
		<div class="container">
			...
			<form method="POST" id="upload_form" enctype="multipart/form-data">
				...
				<span class="block white">!!!!!!!!!! SUPPORT MULTIPLE FILE UPLOAD  !!!!!!!!!!</span>
				<?php
				$maxSizeAllow=ini_get('upload_max_filesize')."B";
					echo "Maximum File Size you Can upload is: $maxSizeAllow Per file. kindly put your content in zip of $maxSizeAllow or lesser size and upload here. if you want to upload multiple file select all file you want to upload. The size limit example : max size allow is 1 MB you have 10MB data to upload. Create 10 zip file contains data less then 1mb. then select all 10 file and upload. You have selected total data of 10 mb and it will upload without issue as each file size less then 10MB";
				?>
				</span>
				
				</label>
				<a href="./uploads" class="button">View Uploaded data from your group</a>
				<div id="pass">
